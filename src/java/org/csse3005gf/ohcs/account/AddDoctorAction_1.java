...
import org.csse3005gf.ohcs.consultation.SendEmail;

/**
 *
 * @author Ben <arkilis@gmail.com>
 */
public class AddDoctorAction_1 extends ActionSupport {
...
//    }
    ...
    public String execute() throws Exception {
        ...
        uo.InsertDoctor(getFname(), getLname(), getTitle(), getEmail(), getPassword(), 
                getGender(), getDob(), getPhone(), getAddress(), 
                getLocation(), getLatitude(), getLongitude(), getLongDescription());
        
        // send welcome email
        SendEmail.sendHTML("smtp.gmail.com", "iteeprintcredit@gmail.com", "wuu1943==", getEmail(), "Successfully Resitered!","t1.html");
        return SUCCESS;
